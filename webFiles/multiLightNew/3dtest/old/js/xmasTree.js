...
//  canvas.onmousemove = onMouseover(e);
  ...
  //TODO: redo these to handle touch events better - ie sense a touch, detect single, double, long, run appropriate fxn
  canvas.addEventListener("contextmenu",function(){alert('hello');}, false);
  canvas.addEventListener("dblclick", function(){alert('hello');}, false);
...
//TODO:create function to get colors from inputs and to keep inputs in sync
