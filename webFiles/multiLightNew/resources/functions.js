...
function clearBack(obj) {
  obj.style.backgroundColor = "#000";   //set input value as black
  obj.nextElementSibling.value = "000";   //set input value as black
}
...
window.addEventListener('load', function(){
    ...
    tree.addEventListener('touchstart', touchObj, false);
    tree.addEventListener('touchmove', touchObj, false);
}, false);
